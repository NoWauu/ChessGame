...
class Pieces:
    def __init__(self) -> None:
        ...
        self.black_pieces = {
            "rook1": [pygame.image.load("IMG/black/rook.png"), [30, 730], (100, 100)],
            "knight1": [pygame.image.load("IMG/black/knight.png"), [130, 730], (100, 100)],
            "bishop_black": [pygame.image.load("IMG/black/bishop.png"), [230, 730], (100, 100)],
            "queen": [pygame.image.load("IMG/black/queen.png"), [330, 730], (100, 100)],
            "king": [pygame.image.load("IMG/black/king.png"), [430, 730], (100, 100)],
            "bishop_white": [pygame.image.load("IMG/black/bishop.png"), [530, 730], (100, 100)],
            "knight2": [pygame.image.load("IMG/black/knight.png"), [630, 730], (100, 100)],
            "rook2": [pygame.image.load("IMG/black/rook.png"), [730, 730], (100, 100)]
        }
